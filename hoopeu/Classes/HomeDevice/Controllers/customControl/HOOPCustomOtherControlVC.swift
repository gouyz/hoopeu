//
//  HOOPCustomOtherControlVC.swift
//  hoopeu
//  自定义遥控器 other
...
private let customOtherControlCell = "customOtherControlCell"
...
class HOOPCustomOtherControlVC: GYZBaseVC {
    ...
    lazy var collectionView: UICollectionView = {
        ...
        collView.register(HOOPCustomControlCell.self, forCellWithReuseIdentifier: customOtherControlCell)
        collView.register(HOOPCustomControlAddCell.self, forCellWithReuseIdentifier: customOtherControlAddCell)
    ...
    func sendZhiLingMqttCmd(code: String,index: Int){
        ...
        let paramDic:[String:Any] = ["token":userDefaults.string(forKey: "token") ?? "","ctrl_dev_id":deviceControlId,"phone":userDefaults.string(forKey: "phone") ?? "","func_num":count,"func_id":funcArr[index]["func_id"]!,"code":code,"ctrl_test":true,"msg_type":"app_other_ctrl","app_interface_tag":""]
...
extension HOOPCustomOtherControlVC : UICollectionViewDataSource,UICollectionViewDelegate{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if indexPath.row == totalCount - 1 {// 创建
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: customOtherControlAddCell, for: indexPath) as! HOOPCustomControlAddCell
            
            return cell
        }else{
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: customOtherControlCell, for: indexPath) as! HOOPCustomControlCell
