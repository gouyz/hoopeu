...
class HOOPProjectorControlVC: GYZBaseVC {
    ...
    func setUpUI(){
        ...
        backBtn.snp.makeConstraints { (make) in
            ...
            make.top.height.width.equalTo(homeBtn)
        }
        
        voicePlusBtn.snp.makeConstraints { (make) in
            make.left.width.equalTo(onOffBtn)
            make.top.equalTo(homeBtn.snp.bottom).offset(kTitleHeight)
            make.height.equalTo(kTitleHeight)
        }
    ...
    lazy var homeBtn : UIButton = {
        let btn = UIButton.init(type: .custom)
        btn.backgroundColor = kBtnClickBGColor
        btn.setImage(UIImage.init(named: "icon_projector_home"), for: .normal)
        btn.tag = 108
    ...
    lazy var backBtn : UIButton = {
        let btn = UIButton.init(type: .custom)
        btn.backgroundColor = kBtnClickBGColor
        btn.setImage(UIImage.init(named: "icon_projector_back"), for: .normal)
        btn.tag = 109
