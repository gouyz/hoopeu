...
private let customIRControlCell = "customIRControlCell"
private let customIRControlAddCell = "customIRControlAddCell"

class HOOPCustomIRVC: GYZBaseVC {
    ...
    lazy var collectionView: UICollectionView = {
        ...
        collView.register(HOOPCustomControlCell.self, forCellWithReuseIdentifier: customIRControlCell)
        collView.register(HOOPCustomControlAddCell.self, forCellWithReuseIdentifier: customIRControlAddCell)
    ...
    func sendStudyMqttCmd(studyState: String,index: Int){
        ...
        let paramDic:[String:Any] = ["token":userDefaults.string(forKey: "token") ?? "","ctrl_dev_id":deviceControlId,"phone":userDefaults.string(forKey: "phone") ?? "","func_num":count,"func_id":funcArr[index]["func_id"]!,"study_state":studyState,"msg_type":"app_other_study","app_interface_tag":index]
    ...
    func sendZhiLingMqttCmd(studyState: String,index: Int){
        ...
        let paramDic:[String:Any] = ["token":userDefaults.string(forKey: "token") ?? "","ctrl_dev_id":deviceControlId,"phone":userDefaults.string(forKey: "phone") ?? "","func_num":count,"func_id":funcArr[index]["func_id"]!,"study_state":studyState,"msg_type":"app_other_ctrl","app_interface_tag":""]
...
extension HOOPCustomIRVC : UICollectionViewDataSource,UICollectionViewDelegate{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if indexPath.row == totalCount - 1 {// 创建
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: customIRControlAddCell, for: indexPath) as! HOOPCustomControlAddCell
            
            return cell
        }else{
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: customIRControlCell, for: indexPath) as! HOOPCustomControlCell
